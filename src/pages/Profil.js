        ...
        <TouchableWithoutFeedback
            ...
            <Block>
                ...
                <TouchableWithoutFeedback onPress={() => navigation.navigate('DeleteProcess', {
                    ...
                    <Iconm name={'dots-horizontal'} size={38} color={theme.COLORS.SIYAH} style={styles.notify}/>
                </TouchableWithoutFeedback>
                {/* <Rating
                type='custom'
                ratingColor='#B23AFC'
...
export class Profil extends React.Component {
    constructor(props) {
        ...
        const {add} = this.props.route.params ? this.props.route.params : false;


        add ? this.props.navigation.addListener('focus', () => {
            this._onRefresh();
        }) : null;
    }
        ...
        return (
            <Block flex style={styles.profile}>
                <Block flex>
                    ...
                    >
                        <CustomHeaderProfile title="mmsalper" navigation={navigation}/>
                        <ScrollView
                        ...
                        >
                            <Block flex style={styles.profileCard}>
                                <TouchableOpacity onPress={() => navigation.navigate('ProfileSettings', {userid: 2})}
                                                  style={{margin: theme.SIZES.BASE}}>
                                    <Block middle style={styles.avatarContainer}>
                                        <Block middle style={styles.avatar}>
                                            <Image
                                                source={profileMe} //addPhoto
                                ...
                                <Block style={styles.info}>
                                    ...
                                    <Block row space="between">
                                        <TouchableOpacity
                                            onPress={() => navigation.navigate('Users', {title: 'Arkadaşlar', userid:2, tur: 1})}>
                                            <Block middle>
                                                <Text
                                                    bold
                                                    size={18}
                                                ...
                                                <Text size={12} color={argonTheme.COLORS.TEXT}>Arkadaşlar</Text>
                                            </Block>
                                        </TouchableOpacity>
                                        <TouchableOpacity
                                            ...
                                            <Block middle>
                                                ...
                                                <Text size={12} color={argonTheme.COLORS.TEXT}>Takipçilerin</Text>
                                            </Block>
                                        </TouchableOpacity>
                                        <TouchableOpacity
                                            onPress={() => navigation.navigate('Users', {
                                            ...
                                            <Block middle>
                                                ...
                                                <Text size={12} color={argonTheme.COLORS.TEXT}>Takip Ettiklerin</Text>
                                            </Block>
                                        </TouchableOpacity>
                                    </Block>
                                </Block>
